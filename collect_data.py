...
variable_sets = [
    {'circuit_size': 28, 'max_subcircuit_width': 10, 'circuit_type': 'hwea'},
    {'circuit_size': 30, 'max_subcircuit_width': 10, 'circuit_type': 'hwea'},
    {'circuit_size': 32, 'max_subcircuit_width': 10, 'circuit_type': 'hwea'}
]
